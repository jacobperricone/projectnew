...
class shooting_splits(NbaDataProvider):
    def __init__(self, team_id, **kwargs):
        ...
        NbaDataProvider.__init__(self, url_modifier=url_modifier, default_params=p_team_shooting,
                                 TeamID=team_id, **kwargs)
...
class team_info(NbaDataProvider):
    def __init__(self, team_id, **kwargs):
        ...
        NbaDataProvider.__init__(self, url_modifier=url_modifier, default_params=p_team_info,
                                 TeamID=team_id, **kwargs)
